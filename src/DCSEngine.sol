...
contract DSCEngine is ReentrancyGuard {
    ...
    function depositCollateral(address tokenCollateralAddress, uint256 amountCollateral) public moreThanZero(amountCollateral) isAllowedToken(tokenCollateralAddress) nonReentrant {
        ...
        // We modify the state so we also emit an event
    ...
    function burnDsc(uint256 amount) public moreThanZero(amount) {
        ...
        _revertIfHealthFactorIsBroken(msg.sender); // This problably won't be ever reached
    }

    function liquidate(address collateral, address user, uint256 debtToCover) moreThanZero(debtToCover) nonReentrant public {
    ...
    // Low-level internal function, do not call unless function calling it is checking for health factor 
